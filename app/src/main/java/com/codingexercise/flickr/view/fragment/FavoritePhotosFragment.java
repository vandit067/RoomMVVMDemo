...
import com.codingexercise.flickr.viewmodel.FavoritePhotosViewModel;
...
public class FavoritePhotosFragment extends BaseFragment implements IPhotosItemInteractionListener {
    ...
    private FavoritePhotosViewModel mFavoritePhotosViewModel;
    ...
    /**
     * Observe data on update of favorite remove from list.
     */
    private final Observer<Photos> mRemoveFavoriteObserver = new Observer<Photos>() {
        @Override
        public void onChanged(@NonNull Photos photos) {
            mPhotosAdapter.removeItem(photos);
            if (mPhotosAdapter.getItemCount() < 1) {
    ...
    // Create new instance of FavoritePhotosFragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mFavoritePhotosViewModel = ViewModelProviders.of(this).get(FavoritePhotosViewModel.class);
        // Observe the LiveData, passing in this activity as the LifecycleOwner and the observer.
        this.mFavoritePhotosViewModel.getPhotosDataObserver().observe(this, this.mResponseDataWrapperObserver);
    }
    ...
    private void setBackgroundImage(@NonNull String imageUrl) {
        Glide.with(FavoritePhotosFragment.this).load(imageUrl)
    ...
    protected void setUp(@NonNull View view) {
        this.initUI();
        this.retrieveFavoritePhotos();
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        if (this.mFavoritePhotosViewModel != null) {
            this.mFavoritePhotosViewModel = null;
        }
    }

    @Override
    public void onFavoritePhotoClick(int position, @NonNull Photos photos) {
        this.mFavoritePhotosViewModel.updateFavoritePhotoDetailsInDb(photos, this.mRemoveFavoriteObserver);
    }
}
